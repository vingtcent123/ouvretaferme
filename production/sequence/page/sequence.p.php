...
new \sequence\SequencePage(function($data) {
	...
	->doCreate(function($data) {
		throw new RedirectAction(\sequence\SequenceUi::url($data->e).'?success=production:Sequence::created');
	});
...
new \sequence\SequencePage()
	...
	->write('doDuplicate', function($data) {
		...
		throw new RedirectAction(\sequence\SequenceUi::url($data->eSequenceNew).'?success=production:Sequence::duplicated');
