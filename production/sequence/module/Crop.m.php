...
class CropModel extends \ModuleModel {
	...
	protected string $module = 'sequence\Crop';
	protected string $package = 'sequence';
	protected string $table = 'sequenceCrop';
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'startAction' => ['enum', [\sequence\Crop::SOWING, \sequence\Crop::PLANTING], 'null' => TRUE, 'cast' => 'enum'],
			'sequence' => ['element32', 'sequence\Sequence', 'cast' => 'element'],
			'farm' => ['element32', 'farm\Farm', 'cast' => 'element'],
			'distance' => ['enum', [\sequence\Crop::SPACING, \sequence\Crop::DENSITY], 'cast' => 'enum'],
			'rows' => ['int8', 'min' => 1, 'max' => NULL, 'null' => TRUE, 'cast' => 'int'],
			'rowSpacing' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => 0.01, 'max' => NULL, 'null' => TRUE, 'cast' => 'float'],
			'plantSpacing' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => 0.01, 'max' => NULL, 'null' => TRUE, 'cast' => 'float'],
			'density' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => 0.01, 'max' => NULL, 'null' => TRUE, 'cast' => 'float'],
