...
class RelationModel extends \ModuleModel {
	...
	protected string $module = 'selling\Relation';
	protected string $package = 'selling';
	protected string $table = 'sellingRelation';
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'parent' => ['element32', 'selling\Product', 'cast' => 'element'],
			'child' => ['element32', 'selling\Product', 'cast' => 'element'],
		...
		$this->propertiesToModule += [
			'farm' => 'farm\Farm',
			'parent' => 'selling\Product',
			'child' => 'selling\Product',
		];
