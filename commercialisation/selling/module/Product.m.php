...
class ProductModel extends \ModuleModel {
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'privatePriceInitial' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => -999999.99, 'max' => 999999.99, 'null' => TRUE, 'cast' => 'float'],
			...
			'proPriceInitial' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => -999999.99, 'max' => 999999.99, 'null' => TRUE, 'cast' => 'float'],
