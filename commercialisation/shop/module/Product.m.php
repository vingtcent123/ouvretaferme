...
class ProductModel extends \ModuleModel {
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'price' => ['decimal', 'digits' => 10, 'decimal' => 4, 'min' => -999999.9999, 'max' => 999999.9999, 'cast' => 'float'],
			'priceInitial' => ['decimal', 'digits' => 10, 'decimal' => 4, 'min' => -999999.9999, 'max' => 999999.9999, 'null' => TRUE, 'cast' => 'float'],
			'limitMin' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => 0.0, 'max' => 999999.99, 'null' => TRUE, 'cast' => 'float'],
			'limitMax' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => 0.0, 'max' => 999999.99, 'null' => TRUE, 'cast' => 'float'],
