...
class ShopModel extends \ModuleModel {
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'customTabs' => ['bool', 'cast' => 'bool'],
			'customDesign' => ['enum', [\shop\Shop::LINE, \shop\Shop::GRID], 'cast' => 'enum'],
			'embedOnly' => ['bool', 'cast' => 'bool'],
			'embedUrl' => ['url', 'null' => TRUE, 'cast' => 'string'],
			'approximate' => ['bool', 'cast' => 'bool'],
			'productInput' => ['enum', [\shop\Shop::PLUS_MINUS, \shop\Shop::TEXT], 'cast' => 'enum'],
	...
	public function whereSharedHash(...$data): ShopModel {
		return $this->where('sharedHash', ...$data);
	}

	public function whereSharedHashExpiresAt(...$data): ShopModel {
	...
	public function whereCustomTabs(...$data): ShopModel {
		return $this->where('customTabs', ...$data);
	}

	public function whereCustomDesign(...$data): ShopModel {
	...
	public function whereProductInput(...$data): ShopModel {
		return $this->where('productInput', ...$data);
	}
