		...
		if($cDepartment->empty()) {
			...
			if($eShop->canWrite()) {
				...
				$h .= '<div class="util-block-help">';
					...
					$h .= '<p>'.s("Les rayons sont une option des boutiques collective qui permet de classer les produits proposés par les producteurs. Vous pouvez par exemple ajouter des rayons <i>Légumes</i>, <i>Crèmerie</i>, <i>Confitures</i>... et associer les catalogues de vos producteurs au bon rayon.").'</p>';
