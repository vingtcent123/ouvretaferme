		...
		$h = '<div class="shop-product-ordered hide" id="shop-basket" '.attr('onrender', 'BasketManage.init('.$eDate['id'].', '.$defaultJson.')').'>';
			...
			$h .= '<div style="display: flex;">';
				...
				if(Shop::isEmbed()) {
					...
					$empty = 'href="'.ShopUi::url($eShop).'/'.$eDate['id'].'"';
					...
					$empty = 'onclick="BasketManage.empty(this, '.$eDate['id'].', true)"';

				}

				$h .= '&nbsp;';
				$h .= '<a '.$empty.' class="shop-basket-empty btn btn-outline-secondary" '.attrs($confirmEmpty).'>';
