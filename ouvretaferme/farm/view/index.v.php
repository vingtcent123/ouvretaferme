...
new AdaptativeView('analyzeWorkingTime', function($data, FarmTemplate $t) {
	...
	if($data->years === []) {
		...
		echo match($data->category) {
			...
			\farm\Farmer::TEAM => $uiAnalyze->getWorkingTime($data->eFarm, $data->year, $data->ccWorkingTimeMonthly, $data->workingTimeWeekly, $data->ccTimesheetAction, $data->ccTimesheetCategory),
