						...
						$h .= '<tr>';
							...
							$h .= '<td class="text-end">';
								...
								$h .= match($eFarmer['status']) {
									...
									Farmer::IN => '<span class="btn btn-danger disabled" title="'.s("Vous ne pouvez pas supprimer un utilisateur fantôme actuellement intégré à l'équipe !").'">'.\Asset::icon('trash').'</span>',
									default => ''
								};
