...
class ConfigurationLib extends ConfigurationCrud {
	...
	public static function getPropertiesUpdate(): array {
		return ['legalName', 'invoiceRegistration', 'invoiceStreet1', 'invoiceStreet2', 'invoicePostcode', 'invoiceCity', 'legalEmail', 'hasVat', 'invoiceVat', 'defaultVat', 'organicCertifier', 'paymentMode', 'documentCopy'];
	}
