	...
	echo '<div class="home-presentation">';
		...
		echo '<div>';
			...
			echo '<ul>';
				...
				echo '<li>'.s("<b>Partagez vos boutiques en ligne avec d'autres producteurs.</b> <small>Vendez à plusieurs sur la même boutique pour partager vos créneaux de vente et simplifier l'expérience pour vos clients.</small>").'</li>';
