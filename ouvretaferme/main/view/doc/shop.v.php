...
new AdaptativeView('shared', function($data, DocTemplate $t) {
	...
	echo '<p>'.s("Lorsque vous démarrez la création d'une boutique collective, {siteName} vous demande d'abord de créer une ferme pour administrer cette boutique. Si vous souhaitez que plusieurs producteurs administrent votre boutique, vous pourrez inviter ces producteurs comme administrateurs de cette ferme dédiée.").'</p>';

	echo '<p>'.s("Une fois la boutique collective créée, vous pouvez démarrer simplement la configuration :").'</p>';
