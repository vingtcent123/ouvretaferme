...
new AdaptativeView('index', function($data, DocTemplate $t) {
	...
	echo '<h2><div class="doc-title-before">'.s("Introduction à la comptabilité sur Ouvretaferme").'</div>'.s("Utiliser Ouvretaferme pour préparer (puis tenir) sa comptabilité").'</h2>';
...
new AdaptativeView('receipts', function($data, DocTemplate $t) {
...
new AdaptativeView('import', function($data, DocTemplate $t) {
	...
	echo '<h5>'.Asset::icon('arrow-right-short').' '.s("Pré-requis : <link>Avoir préparé les données de vos factures</link>", ['link' => '<a href="/doc/accounting">']).'</h5>';
...
new AdaptativeView('bank', function($data, DocTemplate $t) {
	...
	echo '<h5>'.Asset::icon('arrow-right-short').' '.s("Pré-requis : <link>Avoir importé les opérations bancaires</link>", ['link' => '<a href="/doc/accounting:bank#bank-import">']).'</h5>';
	...
	echo '<h5>'.Asset::icon('arrow-right-short').' '.s("Pré-requis : <link>Avoir créé son premier exercice comptable</link>", ['link' => '<a href="/doc/accounting:start#financial-year">']).'</h5>';
...
new AdaptativeView('start', function($data, DocTemplate $t) {
	...
	echo '<div class="doc-intro" id="financial-year">';
...
new AdaptativeView('asset', function($data, DocTemplate $t) {
	...
	echo '<div class="doc-intro" id="import">';
...
new AdaptativeView('vat', function($data, DocTemplate $t) {
	...
	echo '<h2>'.s("Écritures comptables et règles de TVA").'</h2>';
	...
	echo '<table class="td-vertical-align-top tr-bordered">';
		echo '<tr>';
			echo '<th>'.s("Règle").'</th>';
		...
		echo '</tr>';
		echo '<tr>';
			echo '<td>'.s("Exonéré de TVA (export hors UE)").'</td>';
			echo '<td>'.s("Opération qui est dans le champ d'application de la TVA, mais qui n'est pas soumise à la TVA en raison d'une disposition de la loi. En revanche, l'opération entre dans le chiffre d'affaires.").'</td>';
			echo '<td>'.s("Exportations hors UE").'</td>';
		echo '</tr>';
		echo '<tr>';
			echo '<td>'.s("Exonéré de TVA (livraisons intracommunautaires)").'</td>';
			echo '<td>'.s("Opération qui est dans le champ d'application de la TVA, mais qui n'est pas soumise à la TVA en raison d'une disposition de la loi. En revanche, l'opération entre dans le chiffre d'affaires.").'</td>';
			echo '<td>'.s("Livraisons intracommunautaires").'</td>';
		echo '</tr>';
		echo '<tr>';
	...
	echo '<div id="doc-accounting-vat-create-operation">';
