...
new Page()
	...
	->get('/presentation/conformite', fn($data) => throw new ViewAction($data))
	->get('/presentation/adhesion', fn($data) => throw new ViewAction($data))
	->get('/presentation/afocg', fn($data) => throw new PermanentRedirectAction('/presentation/accompagnement'))
	->get('/presentation/accompagnement', fn($data) => throw new ViewAction($data))
