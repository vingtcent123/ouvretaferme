...
class FlowModel extends \ModuleModel {
	...
	protected string $module = 'sequence\Flow';
	protected string $package = 'sequence';
	protected string $table = 'sequenceFlow';
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'crop' => ['element32', 'sequence\Crop', 'null' => TRUE, 'cast' => 'element'],
			...
			'frequency' => ['enum', [\sequence\Flow::W1, \sequence\Flow::W2, \sequence\Flow::W3, \sequence\Flow::W4, \sequence\Flow::M1], 'null' => TRUE, 'cast' => 'enum'],
		]);
