...
class SequenceModel extends \ModuleModel {
	...
	protected string $module = 'sequence\Sequence';
	protected string $package = 'sequence';
	protected string $table = 'sequence';
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'cycle' => ['enum', [\sequence\Sequence::ANNUAL, \sequence\Sequence::PERENNIAL], 'cast' => 'enum'],
			'perennialLifetime' => ['int8', 'min' => 2, 'max' => NULL, 'null' => TRUE, 'cast' => 'int'],
			'farm' => ['element32', 'farm\Farm', 'cast' => 'element'],
			'author' => ['element32', 'user\User', 'cast' => 'element'],
			'duplicateOf' => ['element32', 'sequence\Sequence', 'null' => TRUE, 'cast' => 'element'],
			'plants' => ['int8', 'min' => 1, 'max' => NULL, 'cast' => 'int'],
			'use' => ['enum', [\sequence\Sequence::BED, \sequence\Sequence::BLOCK], 'cast' => 'enum'],
			'bedWidth' => ['int16', 'min' => 1, 'max' => NULL, 'null' => TRUE, 'cast' => 'int'],
			'alleyWidth' => ['int16', 'min' => 1, 'max' => NULL, 'null' => TRUE, 'cast' => 'int'],
			'mode' => ['enum', [\sequence\Sequence::GREENHOUSE, \sequence\Sequence::OPEN_FIELD, \sequence\Sequence::MIX], 'cast' => 'enum'],
			'comment' => ['editor16', 'null' => TRUE, 'cast' => 'string'],
			'visibility' => ['enum', [\sequence\Sequence::PRIVATE, \sequence\Sequence::PUBLIC], 'cast' => 'enum'],
			'createdAt' => ['datetime', 'cast' => 'string'],
			'status' => ['enum', [\sequence\Sequence::ACTIVE, \sequence\Sequence::CLOSED], 'cast' => 'enum'],
		]);
