...
class ReportModel extends \ModuleModel {
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'workingTime' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => 0.0, 'max' => 999999.99, 'cast' => 'float'],
			'workingTimeAdditional' => ['decimal', 'digits' => 8, 'decimal' => 2, 'min' => 0.0, 'max' => 999999.99, 'cast' => 'float'],
