...
class AccountSetting extends \Settings {
	...
	const VAT_CODES_ACCOUNTS = [
		\journal\Operation::VAT_0 => [
			...
			self::CHARGE_ESCOMPTES_ACCOUNT_CLASS, self::CHARGE_OTHER_FINANCIAL_ACCOUNT_CLASS,
		...
		\journal\Operation::VAT_NS => [],
		\journal\Operation::VAT_NCA => [self::CAPITALIZED_PRODUCTION_ACCOUNT_CLASS, self::PRODUCT_SELF_CONSUMPTION_ACCOUNT_CLASS]
	];
