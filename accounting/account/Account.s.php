...
class AccountSetting extends \Settings {
	...
	const RESULT_CLASS = 12; // Résultat
	const PROFIT_RESULT_CLASS = '120';
	const LOSS_RESULT_CLASS = '129';
	const GRANT_ASSET_CLASS = '13';
	const REGULATED_PROVISIONS_CLASS = '14';
	...
	const CHARGE_BANK_ACCOUNT_CLASS = 627;
	const CHARGE_BANK_INTERESTS_ACCOUNT_CLASS = 661;
	const CHARGE_RECEIVABLE_LOSS_ACCOUNT_CLASS = 664; // Pertes sur créances
	const CHARGE_ESCOMPTES_ACCOUNT_CLASS = 665; // Escomptes accordés
	const PRODUCT_ESCOMPTES_ACCOUNT_CLASS = 765; // Escomptes obtenus
	const CHARGE_OTHER_FINANCIAL_ACCOUNT_CLASS = 668; // Autres charges financières
	...
	const PRODUCT_INVESTMENTS_CLASS = 761; // Produits de participations
	const PRODUCT_FINANCIAL_ASSETS_CLASS = 762; // Produits des immos financières
	const PRODUCT_OTHER_RECEIVEABLE_CLASS = 763; // Revenus des autres créances
	const PRODUCT_OTHER_FINANCIAL_ACCOUNT_CLASS = 768; // Autres produits financiers
	...
	const VAT_RULES_ACCOUNTS = [
		\journal\Operation::VAT_0 => [
			self::CHARGE_INSURANCE_ACCOUNT_CLASS, self::CHARGE_BANK_ACCOUNT_CLASS, self::CHARGE_BANK_INTERESTS_ACCOUNT_CLASS, self::CHARGE_RECEIVABLE_LOSS_ACCOUNT_CLASS,
			self::CHARGE_OTHER_FINANCIAL_ACCOUNT_CLASS,
			self::PRODUCT_INVESTMENTS_CLASS, self::PRODUCT_FINANCIAL_ASSETS_CLASS, self::PRODUCT_OTHER_RECEIVEABLE_CLASS, self::PRODUCT_OTHER_FINANCIAL_ACCOUNT_CLASS,
		],
		\journal\Operation::VAT_HC => [
			self::CAPITAL_AND_RESERVES_CLASS, self::RETAINED_EARNINGS_CLASS, self::RESULT_CLASS, self::GRANT_ASSET_CLASS, self::REGULATED_PROVISIONS_CLASS,
			self::PRODUCT_SUBVENTION_ACCOUNT_CLASS, self::PRODUCT_OTHER_ACCOUNT_CLASS, self::PRODUCT_EXCEPTIONAL_ACCOUNT_CLASS,
			self::CHARGE_EXCEPTIONAL_ACCOUNT_CLASS, self::FINANCIAL_INTERNAL_TRANSFER_CLASS
		],
		\journal\Operation::VAT_HCA => [self::CAPITALIZED_PRODUCTION_ACCOUNT_CLASS, self::PRODUCT_SELF_CONSUMPTION_ACCOUNT_CLASS],
		\journal\Operation::VAT_STD_COLLECTED => ['!'.self::PRODUCT_ESCOMPTES_ACCOUNT_CLASS, self::PRODUCT_ACCOUNT_CLASS, self::CHARGE_ESCOMPTES_ACCOUNT_CLASS],
		\journal\Operation::VAT_STD_DEDUCTIBLE => ['!'.self::CHARGE_ESCOMPTES_ACCOUNT_CLASS, self::CHARGE_ACCOUNT_CLASS, self::PRODUCT_ESCOMPTES_ACCOUNT_CLASS]
	];
