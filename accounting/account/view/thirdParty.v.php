...
new AdaptativeView('index', function($data, FarmTemplate $t) {
	...
	echo '<div class="util-block-help">';
		...
		echo s("Pour faciliter la remontée d'informations dans la partie comptabilité (notamment entre les écritures comptables et les factures), vos <link>clients</link> peuvent être associés ici aux tiers.", ['link' => '<a href="'.new \farm\FarmUi()->urlSellingCustomer($data->eFarm).'">']);
	echo '</div>';
