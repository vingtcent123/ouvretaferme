...
new AdaptativeView('close', function($data, FarmTemplate $t) {
	...
	echo '<div class="util-warning">'.s("La fonctionnalité de clôture n'est pas encore éprouvée à 100%. N'utilisez pas les données de {siteName} pour vos déclarations à l'administration fiscale. Si vous détectez des différences ou des problèmes, contactez-nous sur Discord. Merci !").'</div>';
