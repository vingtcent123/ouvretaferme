...
Class AlertUi {
	...
	public static function getError(string $fqn): mixed {
		...
		return match($fqn) {
			...
			'Asset::startDate.future' => s("La date de mise en service doit être passée."),
			'Asset::acquisitionDate.future' => s("La date de mise en service doit être passée."),
			...
			'Asset::economicAmortization.notAllowed' => s("Il ne peut pas y avoir de montant déjà amorti pour une immobilisation sans amortissement"),
			'Asset::economicAmortization.tooMuch' => s("Le montant déjà amorti ne peut pas excéder la valeur de l'immobilisation"),
			...
			'Asset::residualValue.inconsistent' => s("La valeur résiduelle ne peut excéder la valeur de l'immobilisation."),
