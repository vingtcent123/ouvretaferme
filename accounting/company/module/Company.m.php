...
class CompanyModel extends \ModuleModel {
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'reconciliation' => ['enum', [\company\Company::WAITING, \company\Company::PROCESSING, \company\Company::DONE], 'null' => TRUE, 'cast' => 'enum'],
			'fecImport' => ['enum', [\company\Company::WAITING, \company\Company::PROCESSING, \company\Company::DONE], 'null' => TRUE, 'cast' => 'enum'],
		]);

		$this->propertiesList = array_merge($this->propertiesList, [
			'farm', 'reconciliation', 'fecImport'
		]);
	...
	public function whereReconciliation(...$data): CompanyModel {
		return $this->where('reconciliation', ...$data);
	}

	public function whereFecImport(...$data): CompanyModel {
		return $this->where('fecImport', ...$data);
	}
