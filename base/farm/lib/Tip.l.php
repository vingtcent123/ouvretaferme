...
class TipLib extends TipCrud {
	...
	public static function getPrivate(): array {
		return [
			'sequence-weeks', 'mailing-contact-help', 'mailing-campaign-help', 'series-forecast-help', 'feature-rotation', 'selling-photo', 'selling-market-start', 'selling-catalog-start',
