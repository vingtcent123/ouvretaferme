...
new \farm\FarmPage()
	...
	->doUpdateProperties('doUpdateLegal', fn(\farm\Farm $e) => ['legalName', 'legalCountry', 'siret', 'legalStreet1', 'legalStreet2', 'legalPostcode', 'legalCity'], fn() => throw new ReloadAction('farm', 'Farm::updatedLegal'), for: 'legal')
