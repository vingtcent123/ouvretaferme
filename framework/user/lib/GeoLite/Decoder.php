...
class Decoder
{
    ...
    private function decodeDouble($bits)
    {
        ...
        list($data, $double) = unpack('d', $this->maybeSwitchByteOrder($bits));
        return $double;
    }
    ...
    private function decodeFloat($bits)
    {
        ...
        list($data, $float) = unpack('f', $this->maybeSwitchByteOrder($bits));
        return $float;
    }
    ...
    private function decodeInt32($bytes)
    {
        ...
        list($data, $int) = unpack('l', $this->maybeSwitchByteOrder($bytes));
        return $int;
    }
    ...
    {
        return unpack('N', $this->zeroPadLeft($bytes, 4))[1];
    }
