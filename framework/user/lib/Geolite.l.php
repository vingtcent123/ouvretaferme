...
require_once __DIR__.'/GeoLite/Decoder.php';
require_once __DIR__.'/GeoLite/InvalidDatabaseException.php';
require_once __DIR__.'/GeoLite/Metadata.php';
require_once __DIR__.'/GeoLite/Util.php';
...
class GeoliteLib {
    ...
    public function __construct($database = NULL)
    {
		 ...
		 if($database === NULL) {
			 $database = __DIR__.'/GeoLite/GeoLite2-Country.mmdb';
		 } else {
        ...
        $plop = $metadataDecoder->decode($start);
    ...
    private function readNode($nodeNumber, $index)
    {
        ...
        switch ($this->metadata->recordSize) {
            ...
            case 28:
                ...
                return unpack('N', chr($middle) . $bytes)[1];
            case 32:
