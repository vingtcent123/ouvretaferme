...
class AlertUi {
	...
	public static function getError(string $fqn): mixed {
		...
		return match($fqn) {
			...
			'User::deliveryAddress.empty' => s("Vous devez saisir au moins la première ligne de l'adresse, un code postal et une ville pour que votre adresse soit complète !"),
			...
			'User::fullElectronicAddress.check' => s("L'adresse de facturation électronique comprend un identifiant sur 4 chiffres et une adresse de facturation qui commence par les 9 premiers chiffres du SIRET. Les informations fournies ne respectent pas la norme"),
