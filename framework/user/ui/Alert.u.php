...
class AlertUi {
	...
	public static function getError(string $fqn): mixed {
		...
		return match($fqn) {
			...
			'User::fullElectronicAddress.check' => s("L'adresse de facturation électronique saisie ne respecte pas la norme. Elle doit comprendre un identifiant sur 4 chiffres et une adresse de facturation qui commence par les 9 premiers chiffres du SIRET."),
